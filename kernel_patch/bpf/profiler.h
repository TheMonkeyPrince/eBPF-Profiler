...
#define RUN_BLOCK_WITH_BPF_TIMER_AND_ARG(arg, code_block)                     \
    do {                                                         \
        ...
        bpf_profiler_block_timer_result(__FILE__, __LINE__, duration, arg); \
    } while (0)
...
({                                                                         \
    ...
    bpf_profiler_func_timer_result(__FILE__, __LINE__, __duration, arg, #func); \
    __ret_val;                                                             \
})
...
void bpf_profiler_block_timer_result(const char* file, const int start_line, const u64 duration, u32 arg);
void bpf_profiler_func_timer_result(const char* file, const int line, const u64 duration, u32 arg, const char* func_name);
